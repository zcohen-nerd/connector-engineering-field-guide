...
| Low | Cite the wire-count-per-barrel clauses of a public workmanship standard directly (NASA-STD-8739.4 is public; A-620 is the named general reference) beside the structural argument | [Crimping](../hobby/crimping.md), [§5.2](../05-connector-anatomy.md) | NASA-STD-8739.4 exact clause (standards.nasa.gov PDF) | Rule currently rests on manufacturer-doc structure (qualified-combination-or-nothing) without a quoted workmanship clause | **Closable.** Standard located but clause text not yet verified (checked 2026-08); pages deliberately argue from the application-spec structure, which stands on its own |
