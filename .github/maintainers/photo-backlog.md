...
| [servo-connectors.md](../../docs/hobby/servo-connectors.md) deep dive + [families.md](../../docs/hobby/families.md) capsule | 3-pin servo lead (JR/Futaba-style) plugged onto header pins; signal/power/ground wire colors visible. Also: JR-vs-Futaba-J housings side by side (bevel vs tab). | Robotics-heavy audience; servo leads are the most miswired hobby connector class — and the deep dive now teaches the two housings. | **DONE 2026-07** — `servo-sg90-lead.jpg` (SG90 with lead + plug, Suyash Dwivedi CC BY-SA 4.0), reused on the deep dive 2026-08. A plugged-onto-header shot and a JR-vs-J housing pair remain BENCH nice-to-haves |
...
| [micro-fit.md](../../docs/micro-fit.md) deep dive + [internal-pcb-harnessing.md](../../docs/decision-paths/internal-pcb-harnessing.md) + §12 table + [jst-gh.md](../../docs/hobby/jst-gh.md) | Molex Micro-Fit 3.0 mated pair (latch + TPA visible) — ideally beside a Mini-Fit Jr. for the pitch-lookalike shot; JST-GH housing showing the latch arm. | The two most-recommended "upgrade from Dupont" families have no *photos* anywhere on the site (both now have line art — `micro-fit-ladder.svg`, `hobby-jst-gh-id.svg`, 2026-08 — but real latch/TPA macros would still beat it, and the Micro-Fit deep dive is photo-less). | BENCH (Commons empty for both, searched 2026-07) |
...
| [rugged-on-a-budget.md](../../docs/decision-paths/rugged-on-a-budget.md), [deutsch.md](../../docs/deutsch.md) | Deutsch DT 2- or 4-way wedgelock pair, close-up with the orange wedge visible; ideally one half opened showing wire seals. | The path's headline family, and now the DEUTSCH deep dive's §5 (currently line art + the reused J1939 HD photo). DT parts cost a few dollars. | BENCH (Commons search returns junk, 2026-07) |
...
| [barrel-jacks.md](../../docs/hobby/barrel-jacks.md) deep dive + [families.md](../../docs/hobby/families.md) capsule | 5.5 × 2.1/2.5 mm barrel plug + panel jack pair. | "Common sizes, not a standard" lands better with the real pair. | **DONE 2026-07** — `barrel-jack-pair.jpg` (Martin Meise, CC BY-SA 3.0), reused on the deep dive 2026-08 |
| [screw-terminals.md](../../docs/hobby/screw-terminals.md) deep dive + [families.md](../../docs/hobby/families.md) capsule | WAGO-style lever connector with stranded wire; wire ferrules loose + crimped. | Terminal hygiene is hard to draw convincingly. | **DONE 2026-07** — `wago-221-lever.jpg` (Lucasbosch, CC BY-SA 4.0) on the capsule; ferrule spread on crimping.md and the terminals deep dive. PCB screw terminal itself: BENCH (Commons weak) |
