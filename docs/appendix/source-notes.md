...
| Low | Anchor EIA-364 method citations to DLA-hosted adoption notices or SDO-direct listings where they exist | [Qualification template](../tools/connector-qualification-template.md) | DLA adoption-notice PDFs (pattern confirmed for -23) or ECIA-authorized store listings per method | Reseller-listing citations drift | **Closable.** -21/-66/-70 currently cite GlobalSpec reseller listings; -09/-20/-28/-46 named via the labeled lab index (checked 2026-08) |
