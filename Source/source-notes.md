...
| Weather-Pack system (1–6-way, triple-ribbed silicone seals, ~20 A class, −40/+125 °C) | Distributor catalog pages | TTI / Waytek Aptiv Weather-Pack listings | §3.2, site budget path | Distributor listings, flagged for replacement if a manufacturer-hosted system document appears (Aptiv tokenized-URL situation, as with Metri-Pack) |
| U.FL-class board micro-coax (50 Ω, GHz-class, ~0.8 mm ultra-fine cable, SMT tactile-lock snap-on, extraction tool) | Manufacturer series page | Hirose U.FL | site RF path | Family-level; the mating-cycle figure is deliberately unquoted — verify the exact datasheet |
| M23 servo ecosystem: signal 17–19-pole class + power inserts, shielded/IP67-class options, threaded M23×1 and SpeedTec-style quick-lock couplings, multi-vendor (TE Intercontec / Phoenix / binder) | Manufacturer pages | binder M23, TE Intercontec, Phoenix Contact | site motor + feedback path, §3.1 | Family-level; no governing-standard number asserted — cross-vendor intermating flagged as verify |
...
| Micro-Fit 3.0: 8.5 A max "determined by terminal used"; 10.0 A RMF terminal offered; 2–24 ckt W2B/W2W/panel-mount configurations; 30/~250-cycle durability pair | Manufacturer documents | Molex 987650-5984 Rev. 5; Molex PS-43045-001 | site matrix, site Micro-Fit deep dive | RMF = Reduced Mating Force; terminal P/N sets current; product spec is the release authority |
| Molex "Fit" ladder: Nano-Fit 2.5 mm / ~8 A class; Mini-Fit ~13 A class (terminal-dependent); Mega-Fit 5.7 mm / ~23 A per circuit | Manufacturer family pages + distributor-hosted family literature (labeled) | Molex Fit-family, Nano-Fit, Mega-Fit pages; DigiKey Mini-Fit highlight | site Micro-Fit deep dive | Family-level orientation; ATX = Mini-Fit Jr. identification per a distributor technical reference (no ratings drawn); families do not intermate |
...
| 500-cycle durability across 38999 / 26482 / 83513 / 24308 | Specs/catalogs | Amphenol, Aero-Electric, Glenair, MIL-DTL-24308K w/Amend 1 | A4 | Per-family documents cited inline |
