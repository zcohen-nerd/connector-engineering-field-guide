...
| DEUTSCH range: DT cavities / IP6K9K / materials / keying; DTHD 25/60/100 A; HD30/HDP20 shells 18/24, 2–47 cavities, quarter-turn coupling, contacts 4–20; HD10 3–9 cavities + J1939-13 = HD10-9-1939; DRC 24–80 cavities, 100 cycles; Autosport shell styles/keyways, ASX size-24 | Manufacturer pages/catalogs + industry references | TE Connectivity (DT datasheet, HD30/HDP20 catalog, DRC page, Autosport catalog); WireCare (DTHD); CopperHill (J1939-13) | [DEUTSCH deep dive](../deutsch.md), [matrix](../tools/connector-comparison-matrix.md) | Family-level; DTHD figures distributor-hosted pending a TE-hosted equivalent |
| DEUTSCH solid (0460/0462) vs stamped (1060/1062) contact lines; HDT-48-00 serves solid sizes 20/16/12 only | Industry/distributor references | DeutschConnector.com crimp guide; RS HDT-48-00 listing | [DEUTSCH deep dive](../deutsch.md) | Tooling claim; verify against TE application tooling documents for production |
