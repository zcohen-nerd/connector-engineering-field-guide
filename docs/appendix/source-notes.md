...
| Medium | Replace third-party-hosted AMP/Tyco plating whitepapers with manufacturer-hosted copies | [Low-level page](../low-level-signal-contacts.md) | TE-hosted originals of *Golden Rules* and *The Tin Commandments* | Citation drift if the third-party host disappears | **Closable.** No TE-hosted copies surfaced on search (checked 2026-08); copies labeled as third-party-hosted in the meantime |
