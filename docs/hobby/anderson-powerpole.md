...
## 3. Genderless discipline: the orientation IS the polarity
...
## 4. Assembly details nobody documents
...
## 5. Ridiculously useful for power — the wrong answer for signal
