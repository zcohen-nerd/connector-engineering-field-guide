...
| 5 | Good vs bad open-barrel crimp diagram | **Done (2026-08)** — `hobby-crimp-good-vs-bad.svg` | Good crimp annotated (conductor wings on strands, insulation wings on jacket, tips just visible) + three wrongs (strip too long / too short / stray strand); embedded in `crimping.md` with a caption deferring texture to the photo backlog's macro set (P1 there still stands) |
