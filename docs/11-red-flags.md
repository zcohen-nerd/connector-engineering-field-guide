# Red Flags and Beginner Mistakes
...
| Hobby connectors in rugged systems | No sealing, weak latch, unknown vibration life |
...
| No cable labels | Debugging becomes pain soup |
| No mating connector in BOM | Procurement buys half an interface |
| No torque spec | IP sealing and anti-vibration features compromised |
...
| No ground-first mating sequence (hybrids) | Power-before-ground -> latch-up, ground bounce, resets |
| Substituting equivalent parts without qual | Plating/insert/thread/geometry can differ; not drop-in |
