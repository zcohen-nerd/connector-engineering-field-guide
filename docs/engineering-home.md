...
- [Low-Level Signals and Contact Design](low-level-signal-contacts.md) — dry circuits, gold vs. tin, fretting
- [Lifecycle and Procurement Integrity](lifecycle-and-procurement.md) — PCN/EOL, obsolescence, counterfeit avoidance, alternates
