...
| [internal-pcb-harnessing.md](../docs/decision-paths/internal-pcb-harnessing.md) + §12 table + [jst-gh.md](../docs/hobby/jst-gh.md) | Molex Micro-Fit 3.0 mated pair (latch + TPA visible); JST-GH housing showing the latch arm. | The two most-recommended "upgrade from Dupont" families have no *photos* anywhere on the site (the GH deep dive added line art, `hobby-jst-gh-id.svg`, 2026-08 — a real latch-arm macro would still beat it). | BENCH (Commons empty for both, searched 2026-07) |
